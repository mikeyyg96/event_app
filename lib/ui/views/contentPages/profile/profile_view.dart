    ...
    return BaseView<ProfileModel>(
      builder: (context, model, child) => Scaffold(
        ...
        appBar: AppBar(
          ...
          title: Text(
            'Profile', style: stylingInactiveCard,
          ),
          actions: <Widget>[
            Padding(
            ...
            children: <Widget>[
              ...
              Expanded(
                child: Container(
                  ...
                  padding: const EdgeInsets.all(16.0),
                  child: EarningChart(data: model.data,)
                ),
              ),
            ],
          ),
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      Text('Michael Gallego', style: stylingHeader,),
                      Text('- Member -', style: stylingActiveCard,)
                    ],
                  ),
                ),
                SizedBox(height: 30,),
                  ...
                  children: <Widget>[
                    Column(
                      children: <Widget>[
                        ...
                        SizedBox(height: 10,),
                        Text('20', style: stylingActiveCard, textAlign: TextAlign.center,),
                        Text('Events\nParticipated', style: stylingActiveCardNum, textAlign: TextAlign.center,)
                      ],
                    ),
                    Column(
                      children: <Widget>[
                        FloatingActionButton(
                          ...
                          child: Icon(Icons.recent_actors, color: Colors.white,)
                        ),
                        SizedBox(height: 10,),
                        Text('7', style: stylingActiveCard, textAlign: TextAlign.center),
                        Text('Events\nHosted', style: stylingActiveCardNum, textAlign: TextAlign.center,)
                      ],
                    ),
                    Column(
                      children: <Widget>[
                        ...
                        SizedBox(height: 10,),
                        Text('1527', style: stylingActiveCard, textAlign: TextAlign.center,),
                        Text('Reward\nPoints', style: stylingActiveCardNum, textAlign: TextAlign.center,)
                      ],
                    ),
                  ],
                )
